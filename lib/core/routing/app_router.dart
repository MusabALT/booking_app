  ...
  Route generateRoute(RouteSettings setting) {
    ...
    switch (setting.name) {
      ...
      case Routes.roomBookingScreen:
        // Ensure arguments are passed to the RoomBookingScreen
        if (arguments is String) {
          final roomId = arguments;
          return MaterialPageRoute(
            builder: (_) => RoomBookingScreen(roomId: roomId),
          );
        }
        return MaterialPageRoute(
          builder: (_) => const RoomBookingScreen(roomId: ''),
        );
